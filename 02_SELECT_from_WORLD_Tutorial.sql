...
2. Show the name for the countries that have a population of at least 200 million. 
   200 million is 200000000, there are eight zeros. (using WHERE) :
SELECT name 
  FROM world
...
SELECT name, population, area 
  FROM world
WHERE (population > 250000000 OR area > 3000000) AND 
...
SELECT name, ROUND(population/1000000), ROUND(gdp/1000000000) 
  FROM world
